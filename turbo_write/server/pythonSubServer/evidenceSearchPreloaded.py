...
# the max index that evidence search can hold is about 10000000
total_start_id = 13000000
...
# load data
# ---------------------------------------------------------------------------------------------------
embedding_database_dict = loadEmbeddingSearchDatabase(
    range_prefix_dict, embedding_db_folder, tail_dict)

# constructing DB for search
faiss_index.add(embedding_database_dict["matrix"])
print("number of members in index:", faiss_index.ntotal)
...
def create_task():
    ...
    evidence = evidenceSearchWithFaissIndex(query,
                                            faiss_index, num_of_top,
                                            embedding_database_dict,
                                            total_start_id,
